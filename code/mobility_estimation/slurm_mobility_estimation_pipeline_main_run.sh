...
singularity exec --bind=/projects1 ~/singularity/singularity_images/nevrome_coest/nevrome_coest.sif Rscript code/mobility_estimation/mobility_estimation_pipeline_main_run.R ${SLURM_ARRAY_TASK_ID}
