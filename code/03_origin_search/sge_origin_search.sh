...
singularity exec --bind=/mnt/archgen/users/schmid ../singularity/images/nevrome_mobest/nevrome_mobest.sif Rscript code/03_origin_search/03a_origin_search_pipeline-age_resampling+one_kernel_setting.R ${SGE_TASK_ID}
