...
singularity exec --bind=/mnt/archgen/users/schmid ../singularity/images/nevrome_mobest/nevrome_mobest.sif Rscript code/06_alternative_parameter_exploration/MDS_3_dimensions/01_kernel_parameter_determination/02a_crossvalidation_script.R ${i} ${current_ds} ${current_dt} ${current_g}
