...
save(origin_grid_modified, file = "data/origin_search/origin_grid_modified_mds3.RData")
save(origin_grid_mean, file = "data/origin_search/origin_grid_mean_mds3.RData")
save(moving_origin_grid, file = "data/origin_search/moving_origin_grid_mds3.RData")
save(no_data_windows, file = "data/origin_search/no_data_windows_mds3.RData")
