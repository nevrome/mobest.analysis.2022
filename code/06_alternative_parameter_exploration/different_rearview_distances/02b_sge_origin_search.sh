...
singularity exec --bind=/mnt/archgen/users/schmid singularity_mobest.sif Rscript code/06_alternative_parameter_exploration/different_rearview_distances/02a_origin_search_pipeline-age_resampling+one_kernel_setting.R ${SGE_TASK_ID}
